...
corHMM automatically converts multi-column data, like we provided, into a single column of unique combinations that correspond to a particular value. So that users know which traits correspond to which values we provide a data legend.
