...
We now have all the components necessary to create the full model using the getFullMat()function. This functoin requires that the first input be a list of the within rate class matrices and the second argument be the among rate class matrices:
```{r}
